...
MySceneGraph.prototype.displayScene = function() {
  this.processNode(this.idRoot, this.nodes[this.idRoot].textureID, this.nodes[this.idRoot].materialID, this.scene.shaders['default']);
}

MySceneGraph.prototype.processNode = function(root_node_id, init_texture, init_material, active_shader) {

  let root_node = this.nodes[root_node_id]; // The root node object.
  let new_material = init_material, new_texture = init_texture;
  ...
  for (let i = 0; i < root_node.children.length; i++) {
    ...
    this.processNode(root_node.children[i], new_texture, new_material, new_shader);
