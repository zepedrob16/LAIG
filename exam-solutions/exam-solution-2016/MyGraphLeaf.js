...
function MyGraphLeaf(graph, xmlelem) {
  ...
  var type = this.graph.reader.getItem(xmlelem, 'type', ['rectangle', 'cylinder', 'sphere', 'triangle', 'circle', 'patch', 'tree']);
  ...
  if (type == 'rectangle') {
    ...
    this.primitive = new Tree(this.graph.scene, args[0], args[1], args[2], args[3], args[4], args[5]);
  }
  return;
